...
const char* ThingSpeakPublisher::mqttClientID =   THING_SPEAK_CLIENT_ID;
const char* ThingSpeakPublisher::mqttUser       = THING_SPEAK_USER_NAME;
const char* ThingSpeakPublisher::mqttPass       = THING_SPEAK_PASS_WORD;
...
int16_t ThingSpeakPublisher::publishData(Client* outClient) {
    ...
    char topicBuffer[25] = "channels/"; //was 42
